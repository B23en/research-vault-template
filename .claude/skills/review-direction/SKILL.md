...
description: Step back from individual notes and review the research at the meta level — propose new contribution candidates and revisions to the research direction. Use this skill when the user asks to review the direction, step back, look at the big picture, find new contributions, reconsider the goal or scope, or asks where the research is heading — and offer it when a verify-consistency report has recorded a conflict with Direction.md. It surveys the whole vault and files its suggestions as proposals.
---
