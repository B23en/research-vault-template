...
description: Interview the user relentlessly about a plan or design until
  ...
  Use when the user wants to stress-test a research direction, approach, or
  experiment design, or mentions "grill me".
---
...
If a question can be answered by reading the vault's existing notes and master
